...
class TravelOpportunityCandidate(Base):
    ...
    rule_input_hash: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    rule_version: Mapped[str | None] = mapped_column(String(50), nullable=True, index=True)
    rule_calculated_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    ...
    semantic_positive_score: Mapped[float | None] = mapped_column(Float, nullable=True)
    semantic_positive_category: Mapped[str | None] = mapped_column(String(50), nullable=True)
    semantic_negative_score: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    semantic_calculated_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
